...
# mark_description "-std=c99 -O3 -S -o icc/duffsdevice_restrict.s";
	.file "duffsdevice_restrict.c"
...
# mark_begin;
       .align    4
	.globl _spmv
# --- spmv(double *__restrict__, int *__restrict__, int *__restrict__, int, double *__restrict__, double *__restrict__)
_spmv:
# parameter 1: %rdi
# parameter 2: %rsi
# parameter 3: %rdx
...
L_B1.3:                         # Preds L_B1.7 L_B1.2
        ...
        addl      %r11d, %ebp                                   #8.23
        sarl      $2, %ebp                                      #8.23
        andl      $-2147483645, %r11d                           #9.38
        jge       L_B1.22       # Prob 50%                      #9.38
...
L_B1.22:                        # Preds L_B1.3 L_B1.23
                                # Execution count [1.34e+00]
        cmpl      $3, %r11d                                     #10.13
        je        L_B1.17       # Prob 20%                      #10.13
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp r11d xmm0
L_B1.4:                         # Preds L_B1.22
                                # Execution count [1.07e+00]
        cmpl      $2, %r11d                                     #10.13
        je        L_B1.13       # Prob 25%                      #10.13
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp r11d xmm0
L_B1.5:                         # Preds L_B1.4
                                # Execution count [8.04e-01]
        cmpl      $1, %r11d                                     #10.13
        je        L_B1.14       # Prob 33%                      #10.13
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp r11d xmm0
L_B1.6:                         # Preds L_B1.5
                                # Execution count [5.36e-01]
        testl     %r11d, %r11d                                  #10.13
        je        L_B1.15       # Prob 50%                      #10.13
...
L_B1.13:                        # Preds L_B1.4 L_B1.17
        ...
        movslq    (%rsi,%r10,4), %r11                           #16.28
        movsd     (%rdi,%r10,8), %xmm1                          #16.16
        incq      %r10                                          #16.38
        mulsd     (%r8,%r11,8), %xmm1                           #16.26
        addsd     %xmm1, %xmm0                                  #16.9
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp xmm0
L_B1.14:                        # Preds L_B1.5 L_B1.13
                                # Execution count [1.49e+00]
        movslq    (%rsi,%r10,4), %r11                           #18.28
        movsd     (%rdi,%r10,8), %xmm1                          #18.16
        incq      %r10                                          #18.38
        mulsd     (%r8,%r11,8), %xmm1                           #18.26
        addsd     %xmm1, %xmm0                                  #18.9
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp xmm0
L_B1.15:                        # Preds L_B1.6 L_B1.14
                                # Execution count [1.49e+00]
        decl      %ebp                                          #22.16
        js        L_B1.7        # Prob 18%                      #22.21
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp xmm0
L_B1.16:                        # Preds L_B1.15
                                # Execution count [1.22e+00]
        movslq    (%rsi,%r10,4), %r11                           #12.28
        movsd     (%rdi,%r10,8), %xmm1                          #12.16
        incq      %r10                                          #12.38
        mulsd     (%r8,%r11,8), %xmm1                           #12.26
        addsd     %xmm1, %xmm0                                  #12.9
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp xmm0
L_B1.17:                        # Preds L_B1.22 L_B1.16
                                # Execution count [1.49e+00]
        movslq    (%rsi,%r10,4), %r11                           #14.28
        movsd     (%rdi,%r10,8), %xmm1                          #14.16
        incq      %r10                                          #14.38
        mulsd     (%r8,%r11,8), %xmm1                           #14.26
        addsd     %xmm1, %xmm0                                  #14.9
        jmp       L_B1.13       # Prob 100%                     #14.9
        .align    4
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebp xmm0
..LCFI5:
# mark_end;
